...
- La finalul fiecărei sesiuni de lucru relevante se actualizează `docs/ROADMAP.md` — ce e bifat, ce urmează (se editează pe loc, nu se adaugă la nesfârșit).
...
La începutul unei sesiuni noi (alt cont/context), citește acest fișier + `docs/DESIGN_TARGET.md` + `docs/ROADMAP.md` — primul îți spune **unde mergem**, al doilea **unde am ajuns**. Deschide `docs/ARCHITECTURE.md` doar dacă ai nevoie de detalii.
